...
<#
 ...
 Supported values for this parameter are 35 or 36. The default values is 35 (for a CNTK Python 35 environment).
...
Param(
    ...
    [Parameter(Mandatory=$false)] [ValidateSet("35", "36")] [string] $PyVersion = "35",
