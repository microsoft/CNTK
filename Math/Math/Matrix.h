...
#define USE_TIME_BASED_SEED ULONG_MAX
    ...
    public:
        ...
        static void ConvolveAndWeightedAdd(ElemType alpha, const Matrix<ElemType>& a, const bool transposeA, const Matrix<ElemType>& b, const bool transposeB, ElemType beta, Matrix<ElemType>& c, size_t colStep, bool padding);
