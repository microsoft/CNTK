...
#define USE_TIME_BASED_SEED ULONG_MAX
    ...
    public:
        ...
        static void ConvolveAndWeightedAdd(ElemType alpha, const Matrix<ElemType>& a, const Matrix<ElemType>& b, ElemType beta, Matrix<ElemType>& c, size_t colStep, bool padding);
