...
#pragma region Static BLAS Functions
    ...
    void Matrix<ElemType>::ConvolveAndWeightedAdd(ElemType alpha, const Matrix<ElemType>& a, const Matrix<ElemType>& b,
        ElemType beta, Matrix<ElemType>& c, size_t imageWidth, size_t kernelWidth, size_t stepSize, bool padding)
    {
        DecideAndMoveToRightDevice(a, b, c);
        ...
        {
            GPUSparseMatrix<ElemType>::ConvolveAndWeightedAdd(alpha, *a.m_GPUMatrix, *b.m_GPUSparseMatrix, beta, *c.m_GPUMatrix, imageWidth, kernelWidth, stepSize, padding);
        }
        else
        {
            NOT_IMPLEMENTED;
