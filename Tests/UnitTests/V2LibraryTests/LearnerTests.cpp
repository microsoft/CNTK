...
void TestTrainingParametersSchedule()
{
    ...
    assert(schedule4.GetRefMinibatchSize() == LearningRateSchedule::UnspecifiedRefMBSize);
    ...
    assert(schedule6.GetRefMinibatchSize() == MomentumSchedule::UnspecifiedRefMBSize);
