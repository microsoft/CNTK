...
BOOST_AUTO_TEST_CASE(TestParityCandCppLSTMModel)
{
    ...
    RequireClose(result1, result3, 0.01);
    RequireClose(result1, result4, 0.01);
    ...
    // Sequence mode.
    {
        ...
        RequireClose(result, cresult1, 0.01);
        RequireClose(result1, cresult1, 0.01);
        RequireClose(result2, cresult2, 0.01);
        RequireClose(result3, cresult3, 0.01);
        RequireClose(result4, cresult4, 0.01);
