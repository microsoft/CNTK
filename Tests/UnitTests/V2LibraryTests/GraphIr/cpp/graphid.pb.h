...
class Node : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:graphIR.Node) */ {
 public:
  ...
  // map<string, .graphIR.IOArg> inputs = 3;
  int inputs_size() const;
  void clear_inputs();
  static const int kInputsFieldNumber = 3;
  const ::google::protobuf::Map< ::std::string, ::graphIR::IOArg >&
      inputs() const;
  ::google::protobuf::Map< ::std::string, ::graphIR::IOArg >*
      mutable_inputs();

  // map<string, .graphIR.IOArg> outputs = 4;
  ...
  // map<string, .graphIR.InitArg> init_attrs = 5;
  int init_attrs_size() const;
  void clear_init_attrs();
  static const int kInitAttrsFieldNumber = 5;
  ...
  static const int kExtAttrsFieldNumber = 7;
  const ::google::protobuf::Map< ::std::string, ::std::string >&
      ext_attrs() const;
  ::google::protobuf::Map< ::std::string, ::std::string >*
      mutable_ext_attrs();
...
inline const ::google::protobuf::Map< ::std::string, ::graphIR::IOArg >&
Node::inputs() const {
  // @@protoc_insertion_point(field_map:graphIR.Node.inputs)
  return inputs_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::graphIR::IOArg >*
Node::mutable_inputs() {
  // @@protoc_insertion_point(field_mutable_map:graphIR.Node.inputs)
...
inline const ::google::protobuf::Map< ::std::string, ::graphIR::IOArg >&
Node::outputs() const {
  // @@protoc_insertion_point(field_map:graphIR.Node.outputs)
  return outputs_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::graphIR::IOArg >*
Node::mutable_outputs() {
  // @@protoc_insertion_point(field_mutable_map:graphIR.Node.outputs)
