...
const ::google::protobuf::Descriptor* Node_InputsEntry_descriptor_ = NULL;
const ::google::protobuf::Descriptor* Node_OutputsEntry_descriptor_ = NULL;
...
void protobuf_AssignDesc_graphid_2eproto() {
  ...
  static const int IOArg_offsets_[3] = {
  ...
  Node_InputsEntry_descriptor_ = Node_descriptor_->nested_type(0);
  Node_OutputsEntry_descriptor_ = Node_descriptor_->nested_type(1);
  Node_InitAttrsEntry_descriptor_ = Node_descriptor_->nested_type(2);
  Node_AttrsEntry_descriptor_ = Node_descriptor_->nested_type(3);
  Node_ExtAttrsEntry_descriptor_ = Node_descriptor_->nested_type(4);
...
void protobuf_AddDesc_graphid_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\n\006dbytes\030\003 \001(\005\022\r\n\005shape\030\004 \003(\005\".\n\007InitArg"
    "\022\016\n\006dbytes\030\001 \001(\003\022\023\n\013data_base64\030\002 \001(\t\"\245\004"
    "\n\004Node\022\014\n\004name\030\001 \001(\t\022\n\n\002op\030\002 \001(\t\022)\n\006inpu"
    "ts\030\003 \003(\0132\031.graphIR.Node.InputsEntry\022+\n\007o"
    "utputs\030\004 \003(\0132\032.graphIR.Node.OutputsEntry"
    "\0220\n\ninit_attrs\030\005 \003(\0132\034.graphIR.Node.Init"
    "AttrsEntry\022\'\n\005attrs\030\006 \003(\0132\030.graphIR.Node"
    ".AttrsEntry\022.\n\text_attrs\030\007 \003(\0132\033.graphIR"
    ".Node.ExtAttrsEntry\032=\n\013InputsEntry\022\013\n\003ke"
    "y\030\001 \001(\t\022\035\n\005value\030\002 \001(\0132\016.graphIR.IOArg:\002"
    "8\001\032>\n\014OutputsEntry\022\013\n\003key\030\001 \001(\t\022\035\n\005value"
    "\030\002 \001(\0132\016.graphIR.IOArg:\0028\001\032B\n\016InitAttrsE"
    "ntry\022\013\n\003key\030\001 \001(\t\022\037\n\005value\030\002 \001(\0132\020.graph"
    "IR.InitArg:\0028\001\032,\n\nAttrsEntry\022\013\n\003key\030\001 \001("
    "\t\022\r\n\005value\030\002 \001(\t:\0028\001\032/\n\rExtAttrsEntry\022\013\n"
    "\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\t:\0028\001\"M\n\005Graph\022&"
    "\n\ngraph_info\030\001 \001(\0132\022.graphIR.GraphInfo\022\034"
    "\n\005nodes\030\002 \003(\0132\r.graphIR.Nodeb\006proto3", 1036);
...
void Node::SharedCtor() {
  ...
  inputs_.SetEntryDescriptor(
      &::graphIR::Node_InputsEntry_descriptor_);
  outputs_.SetAssignDescriptorCallback(
      protobuf_AssignDescriptorsOnce);
  outputs_.SetEntryDescriptor(
      &::graphIR::Node_OutputsEntry_descriptor_);
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        if (tag == 26) {
         parse_inputs:
          DO_(input->IncrementRecursionDepth());
         parse_loop_inputs:
          Node_InputsEntry::Parser< ::google::protobuf::internal::MapField<
              ::std::string, ::graphIR::IOArg,
              ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
              ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
              0 >,
            ::google::protobuf::Map< ::std::string, ::graphIR::IOArg > > parser(&inputs_);
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, &parser));
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            parser.key().data(), parser.key().length(),
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "graphIR.Node.InputsEntry.key"));
        } else {
          goto handle_unusual;
        }
      ...
      case 4: {
        if (tag == 34) {
          DO_(input->IncrementRecursionDepth());
         parse_loop_outputs:
          Node_OutputsEntry::Parser< ::google::protobuf::internal::MapField<
              ::std::string, ::graphIR::IOArg,
              ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
              ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
              0 >,
            ::google::protobuf::Map< ::std::string, ::graphIR::IOArg > > parser(&outputs_);
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, &parser));
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            parser.key().data(), parser.key().length(),
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "graphIR.Node.OutputsEntry.key"));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(34)) goto parse_loop_outputs;
        if (input->ExpectTag(42)) goto parse_loop_init_attrs;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(42)) goto parse_loop_init_attrs;
        if (input->ExpectTag(50)) goto parse_loop_attrs;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(50)) goto parse_loop_attrs;
        if (input->ExpectTag(58)) goto parse_loop_ext_attrs;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
...
void Node::SerializeWithCachedSizes(
  ...
  if (!this->inputs().empty()) {
    typedef ::google::protobuf::Map< ::std::string, ::graphIR::IOArg >::const_pointer
        ConstPtr;
    typedef ConstPtr SortItem;
    typedef ::google::protobuf::internal::CompareByDerefFirst<SortItem> Less;
    struct Utf8Check {
    ...
    if (output->IsSerializationDeterminstic() &&
      ...
      typedef ::google::protobuf::Map< ::std::string, ::graphIR::IOArg >::size_type size_type;
      size_type n = 0;
      for (::google::protobuf::Map< ::std::string, ::graphIR::IOArg >::const_iterator
          it = this->inputs().begin();
          it != this->inputs().end(); ++it, ++n) {
        items[n] = SortItem(&*it);
      }
      ::std::sort(&items[0], &items[n], Less());
      ::google::protobuf::scoped_ptr<Node_InputsEntry> entry;
      for (size_type i = 0; i < n; i++) {
  ...
  if (!this->outputs().empty()) {
    ...
    if (output->IsSerializationDeterminstic() &&
      ...
      ::std::sort(&items[0], &items[n], Less());
      ::google::protobuf::scoped_ptr<Node_OutputsEntry> entry;
      for (size_type i = 0; i < n; i++) {
