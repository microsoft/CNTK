        ...
        namespace CNTK
        {
            namespace Test
            {
                ...
                BOOST_FIXTURE_TEST_CASE(CPUMatrixElementOperations, RandomSeedFixture)
                {
                    ...
                    m0Inverse(0, 0) = 1.0; m0Inverse(0, 1) = 1 / 2.0; m0Inverse(0, 2) = 1 / 3.0;
                    m0Inverse(1, 0) = 1 / 4.0; m0Inverse(1, 1) = 1 / 5.0; m0Inverse(1, 2) = 1 / 6.0;
                ...
                BOOST_FIXTURE_TEST_CASE(CPUKhatriRaoProduct, RandomSeedFixture)
                {
                    ...
                    mA(1, 0) = 0.9058; mA(1, 1) = 0.6324; mA(1, 2) = 0.5469; mA(1, 3) = 0.1576;
                    mA(2, 0) = 0.1270; mA(2, 1) = 0.0975; mA(2, 2) = 0.9575; mA(2, 3) = 0.9706;

                    DMatrix mB(2, 4);
                    mB(0, 0) = 0.9572; mB(0, 1) = 0.8003; mB(0, 2) = 0.4218; mB(0, 3) = 0.7922;
                    mB(1, 0) = 0.4854; mB(1, 1) = 0.1419; mB(1, 2) = 0.9157; mB(1, 3) = 0.9595;

                    DMatrix mD(6, 4);
                    mD(0, 0) = 0.7798; mD(0, 1) = 0.7310; mD(0, 2) = 0.1175; mD(0, 3) = 0.7644;
                    mD(1, 0) = 0.8670; mD(1, 1) = 0.5061; mD(1, 2) = 0.2307; mD(1, 3) = 0.1249;
                    mD(2, 0) = 0.1215; mD(2, 1) = 0.0781; mD(2, 2) = 0.4038; mD(2, 3) = 0.7689;
                    mD(3, 0) = 0.3954; mD(3, 1) = 0.1296; mD(3, 2) = 0.2550; mD(3, 3) = 0.9258;
                    mD(4, 0) = 0.4396; mD(4, 1) = 0.0897; mD(4, 2) = 0.5008; mD(4, 3) = 0.1512;
                    mD(5, 0) = 0.0616; mD(5, 1) = 0.0138; mD(5, 2) = 0.8768; mD(5, 3) = 0.9313;
                ...
                BOOST_FIXTURE_TEST_CASE(CPUAddColumnReshapeProductOf, RandomSeedFixture)
                {
                    ...
                    mA(1, 0) = 0.0357; mA(1, 1) = 0.3922;
                    mA(2, 0) = 0.8491; mA(2, 1) = 0.6555;
                    mA(3, 0) = 0.9340; mA(3, 1) = 0.1712;
                    mA(4, 0) = 0.6787; mA(4, 1) = 0.7060;
                    mA(5, 0) = 0.7577; mA(5, 1) = 0.0318;

                    DMatrix mB(3, 2);
                    mB(0, 0) = 0.2769; mB(0, 1) = 0.8235;
                    mB(1, 0) = 0.0462; mB(1, 1) = 0.6948;
                    mB(2, 0) = 0.0971; mB(2, 1) = 0.3171;

                    DMatrix mD(2, 2);
                    mD(0, 0) = 0.2867; mD(0, 1) = 1.2913;
                    mD(1, 0) = 0.1266; mD(1, 1) = 0.4520;

                    DMatrix mE(2, 2);
                    mE(0, 0) = 0.2657; mE(0, 1) = 1.0923;
                    mE(1, 0) = 0.3636; mE(1, 1) = 0.6416;
                ...
                BOOST_FIXTURE_TEST_CASE(CPUAssignRepeatOf, RandomSeedFixture)
                {
                    ...
                    DMatrix m2(6, 6);
                    m2(0, 0) = 1; m2(0, 1) = 6; m2(0, 2) = 11; m2(0, 3) = 1; m2(0, 4) = 6; m2(0, 5) = 11;
                    m2(1, 0) = 2; m2(1, 1) = 7; m2(1, 2) = 12; m2(1, 3) = 2; m2(1, 4) = 7; m2(1, 5) = 12;
                    m2(2, 0) = 1; m2(2, 1) = 6; m2(2, 2) = 11; m2(2, 3) = 1; m2(2, 4) = 6; m2(2, 5) = 11;
                    m2(3, 0) = 2; m2(3, 1) = 7; m2(3, 2) = 12; m2(3, 3) = 2; m2(3, 4) = 7; m2(3, 5) = 12;
                    m2(4, 0) = 1; m2(4, 1) = 6; m2(4, 2) = 11; m2(4, 3) = 1; m2(4, 4) = 6; m2(4, 5) = 11;
                    m2(5, 0) = 2; m2(5, 1) = 7; m2(5, 2) = 12; m2(5, 3) = 2; m2(5, 4) = 7; m2(5, 5) = 12;
