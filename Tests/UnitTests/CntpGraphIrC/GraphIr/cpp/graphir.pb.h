...
#ifndef PROTOBUF_graphir_2eproto__INCLUDED
#define PROTOBUF_graphir_2eproto__INCLUDED
...
class GraphInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:graphIR.GraphInfo) */ {
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_graphir_2eproto_impl();
  friend void  protobuf_AddDesc_graphir_2eproto_impl();
  friend void protobuf_AssignDesc_graphir_2eproto();
  friend void protobuf_ShutdownFile_graphir_2eproto();
...
#endif  // PROTOBUF_graphir_2eproto__INCLUDED
