...
void protobuf_AssignDesc_graphir_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_graphir_2eproto() {
  protobuf_AddDesc_graphir_2eproto();
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_graphir_2eproto);
}
...
void protobuf_ShutdownFile_graphir_2eproto() {
...
void protobuf_InitDefaults_graphir_2eproto_impl() {
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_graphir_2eproto_once_);
void protobuf_InitDefaults_graphir_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_graphir_2eproto_once_,
                 &protobuf_InitDefaults_graphir_2eproto_impl);
}
void protobuf_AddDesc_graphir_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_graphir_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\rgraphir.proto\022\007graphIR\"\213\002\n\tGraphInfo\022\022"
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "graphir.proto", &protobuf_RegisterTypes);
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_graphir_2eproto);
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_graphir_2eproto_once_);
void protobuf_AddDesc_graphir_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_graphir_2eproto_once_,
                 &protobuf_AddDesc_graphir_2eproto_impl);
}
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_graphir_2eproto {
  StaticDescriptorInitializer_graphir_2eproto() {
    protobuf_AddDesc_graphir_2eproto();
  }
} static_descriptor_initializer_graphir_2eproto_;
...
GraphInfo::GraphInfo()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_graphir_2eproto();
  SharedCtor();
