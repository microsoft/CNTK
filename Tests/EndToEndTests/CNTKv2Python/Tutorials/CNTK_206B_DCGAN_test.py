...
expectedEvalErrorByDeviceId = { 0: 1.8 }
expectedEvalErrorAtolByDeviceId = { 0: 0.2 }
...
def test_cntk_206B_dcgan_evalCorrect(nb):
    ...
    assert np.isclose(float(m.group('actualEvalError')), expectedEvalErrorByDeviceId[0], atol=expectedEvalErrorAtolByDeviceId[0])
