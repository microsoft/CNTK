...
sys.path.append(os.path.join(abs_path, "..", "..", "..", "..", "Examples", "Image", "Classification", "VGG", "Python"))
from prepare_test_data import prepare_ImageNet_data
from VGG16_ImageNet_Distributed import vgg16_train_and_eval

#TOLERANCE_ABSOLUTE = 2E-1

def test_vgg16_error(device_id):
    ...
    test_error = vgg16_train_and_eval(train_data, test_data, 
