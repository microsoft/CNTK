...
class Input(InputComputationNode):
...
class SparseInput(InputComputationNode):
...
class ImageInput(ImageInputComputationNode):
...
class SparseImageInput(ImageInputComputationNode):
