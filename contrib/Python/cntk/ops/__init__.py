...
def reduce_sum(value, axis=0, name=None):
    """
    For axis >= 1 computes the sum of a tensor along the specifed axis. In the result the corresponding axis is dropped, i.e. the rank of the result tensore is smaller that the rank of the input tensor.
    If axis == 0 the reduction is taken over all tensor values, and the result is a tensor of rank one with one dimension.
