...
class AbstractContext(with_metaclass(ABCMeta, object)):
    ...
    def _generate_train_config(self, root_nodes, optimizer, input_readers, override_existing):
        ...
        description, inputs, reader = self._generate_config(
            root_nodes, input_readers)
    ...
    def _sanitized_asarray(data):
        ...
        Returns:
            out : ndarray
                NumPy array with NaNs and Infs mapped to NumPy versions of them.
...
class Context(AbstractContext):
    ...
    def eval(self, node, input_reader=None, backward_pass=False, input_name=None):
        ...
        config_content = self._generate_eval_config(
            node, input_reader, backward_pass)
