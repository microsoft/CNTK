...
from .utils import is_tensor, is_tensor_list, sanitize_var_map, \
        create_Value_from_NumPy, create_Value_for_Variable, \
        remove_masked_elements, ones_like
...
class LocalExecutionContext(AbstractContext):
    ...
    def eval(self, op, input_map=None, backward_pass=False):
        '''
        ...
        if backward_pass:
            ...
            for v, o in forward_output.items():
                ones_grad = ones_like(o, self)
                root_gradients[v] = ones_grad
            root_gradients = sanitize_var_map(root_gradients, self)
