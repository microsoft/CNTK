...
%template(PairNDArrayViewPtrVectorBool) std::pair<std::vector<std::shared_ptr<CNTK::NDArrayView>>, std::vector<bool>>;
...
RENAME_AND_MAKE_PRIVATE(CNTK::Value, UnpackVariableValue);
