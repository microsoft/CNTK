...
IGNORE_FUNCTION CNTK::RNNTError;
IGNORE_FUNCTION CNTK::Getbias;
IGNORE_FUNCTION CNTK::GetUttInfo;
IGNORE_FUNCTION CNTK::PlusBroadcast;
IGNORE_FUNCTION CNTK::TimeReduction;
IGNORE_FUNCTION CNTK::ForwardBackward;
IGNORE_FUNCTION CNTK::RNNT;
