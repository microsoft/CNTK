...
# To test models locally, create folder 'testdata' and put in model folders. 
# For example.
#   .
#   +-- testdata
#   |   +-- model1
...
#   |   +-- model2
#     ...
base_dir = 'testdata' if not 'CNTK_EXTERNAL_TESTDATA_SOURCE_DIRECTORY' in os.environ else os.path.join(os.environ['CNTK_EXTERNAL_TESTDATA_SOURCE_DIRECTORY'], 'onnx_models')
