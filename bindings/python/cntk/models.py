...
def Sequential(layers):
    ...
    #sequential = reduce(lambda f, g: f >> g, layers, identity)
    sequential = reduce(lambda f, g: f >> g, layers)
    # TODO: Test this^^ without identity.
    ...
    #    if len(sequential.placeholders) != len(arg.placeholders):
    #        raise AssertionError('boom')
    return Block(sequential, 'Sequential', Record(layers=layers))
