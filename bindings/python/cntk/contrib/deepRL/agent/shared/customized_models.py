...
class CustomizedModels:
    """Customized Q function or log of policy function.

    If models from StandardizedModels are not adequate, write your own model
    here as a function, which takes two required arguments 'shape_of_inputs',
    'number_of_outputs', and one optional argument 'loss_function', and outputs
    a dictionary containing 'inputs', 'outputs', 'f' and 'loss'. In the config
    file, set QRepresentation or PolicyRepresentation to the function name.
    QLearning/PolicyGradient will then search within this class for the
    specified model.
    """
