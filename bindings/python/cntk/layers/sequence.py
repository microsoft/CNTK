...
def QRNN(filter_shape=2, hidden_dim=None, activation=C.tanh, return_full_state=False):
    """
    ...
    Args:
        filter_shape: integer, the size of convolution across the temporal
        dynamic axis. size 2 reduces down to LSTM implementation.
        hidden_dim: integer, size of hidden dim of h, c and o
