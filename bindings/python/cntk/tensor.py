...
class NDArrayViewOpsMixin(object):
    ...
    def splice(*args, axis=-1, out=None): # negative axis will insert a new axis
        ...
        #         But it also seems that numpy.concatenate does not allow to batch a long a new axis.
        #         To create a new axis, numpy has numpy.stack().
        axis = len(args[0].shape) - 1 - axis # swap to C++ API convention --TODO: put this instead into the derived Python class
