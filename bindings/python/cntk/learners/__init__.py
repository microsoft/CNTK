...
class ExampleProximalGradientDescentLearner(UserLearner):

    '''
    Example class of an user-defined learners using proximal gradient descent methods.
    '''

    def __init__(self, parameters, lr_schedule, l1_regularization_weight=0.0, l2_regularization_weight=0.0):
        super(ExampleProximalGradientDescentLearner, self).__init__(parameters, lr_schedule)
