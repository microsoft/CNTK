...
-  `MNIST <https://github.com/Microsoft/CNTK/blob/v2.alpha4/bindings/python/examples/MNIST/SimpleMNIST.py>`__:
...
-  `CifarResNet <https://github.com/Microsoft/CNTK/blob/v2.alpha4/bindings/python/examples/CifarResNet/CifarResNet.py>`__:
...
-  `SequenceClassification <https://github.com/Microsoft/CNTK/blob/v2.alpha4/bindings/python/examples/SequenceClassification/SequenceClassification.py>`__:
   An LSTM sequence classification model for text data.

-  `Sequence2Sequence <https://github.com/Microsoft/CNTK/blob/v2.alpha4/bindings/python/examples/Sequence2Sequence/Sequence2Sequence.py>`__:
   A sequence to sequence grapheme to phoneme translation model that
   trains on the CMUDict corpus.

-  `NumpyInterop <https://github.com/Microsoft/CNTK/blob/v2.alpha4/bindings/python/examples/NumpyInterop/FeedForwardNet.py>`__
