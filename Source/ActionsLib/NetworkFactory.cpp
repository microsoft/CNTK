...
bool TryGetNetworkFactory(const ConfigRecordType& config, function<ComputationNetworkPtr(DEVICEID_TYPE)>& createNetworkFn)
{
    ...
    else if (config.Exists(L"BrainScriptNetworkBuilder") || config.Exists(L"ExperimentalNetworkBuilder" /*legacy name*/))
    {
        ...
        fprintf(stderr, "\nguoye: TryGetNetworkFactory: debug 1.\n");
        ...
        fprintf(stderr, "\nguoye: TryGetNetworkFactory: debug 2.\n");
        ...
        fprintf(stderr, "\nguoye: TryGetNetworkFactory: debug 3.\n");
        ...
        fprintf(stderr, "\nguoye: TryGetNetworkFactory: debug 4.\n");
        ...
        fprintf(stderr, "\nguoye: TryGetNetworkFactory: debug 5.\n");
