...
public:
    ...
    virtual void InitRecurrentConfig(const ConfigParameters& config)
    {
        ...
        m_forgetGateInitVal = config("forgetGateInitVal", "-1").operator ElemType();
        m_inputGateInitVal = config("inputGateInitVal", "-1").operator ElemType();
        m_outputGateInitVal = config("outputGateInitVal", "-1").operator ElemType();
