...
public:
    ...
    ComputationNodePtr LatticeFreeMMI(const ComputationNodePtr label, const ComputationNodePtr prediction, const ComputationNodePtr logPrior, const std::wstring fstFilePath, const std::wstring smapFilePath, ElemType squashingFactor, int alignmentWindow, ElemType ceweight, ElemType boosted, ElemType denWeight, ElemType boostedSil, std::wstring silenceSenoStr, std::wstring nodeName = L"");
    ComputationNodePtr LatticeFreeMMINegStream(const ComputationNodePtr label, const ComputationNodePtr negLabel, const ComputationNodePtr prediction, const ComputationNodePtr logPrior, const std::wstring fstFilePath, const std::wstring smapFilePath, ElemType squashingFactor, int alignmentWindow, ElemType ceweight, ElemType boosted, std::wstring nodeName = L"");    
