...
public:
    ...
    ComputationNodePtr StochasticBinaryPre(const ComputationNodePtr a, const int nMiniBatch, const int nPreTrain, const float annealRate, const std::wstring nodeName = L"");
