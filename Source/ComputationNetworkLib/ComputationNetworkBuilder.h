...
public:
    ...
    ComputationNodePtr LatticeFreeMMI(const ComputationNodePtr label, const ComputationNodePtr prediction, const ComputationNodePtr logPrior, const std::wstring fstFilePath, const std::wstring smapFilePath, ElemType acweight, int alignmentWindow, ElemType ceweight, bool useLabelAsCEtarget, const ElemType frameDropThresh, const ElemType l2NormFactor, bool isCTCmodel, bool usePrior, std::wstring nodeName = L"");
