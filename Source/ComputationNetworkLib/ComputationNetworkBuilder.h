...
public:
    ...
    ComputationNodePtr CreateLearnableParameter(const std::wstring& paramName, const TensorShape& tensorShape, DEVICEID_TYPE deviceId = DEVICEID_NOTYETDETERMINED); // V2
