...
#endif
    ComputationNodePtr BiVfsmn(const ComputationNodePtr in, const ComputationNodePtr lFilter, const ComputationNodePtr rFilter, size_t lOrder, size_t rOrder, size_t lStride, size_t rStride, size_t padding, const std::wstring nodeName = L"");
