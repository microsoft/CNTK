...
public:
    ...
    ComputationNodePtr CreateROIPoolingNode(const std::wstring& nodeName, const size_t W, const size_t H, ImageLayoutKind imageLayoutKind);
    ...
    ComputationNodePtr AveragePooling(const ComputationNodePtr inputValues,
                                      const size_t windowWidth, const size_t windowHeight, const size_t horizontalSubsample, const size_t verticalSubsample, ImageLayoutKind imageLayoutKind,
                                      const std::wstring nodeName = L"");
    ComputationNodePtr ROIPooling(const ComputationNodePtr inputValues, const ComputationNodePtr inputROIs, const size_t W, const size_t H, ImageLayoutKind imageLayoutKind, const std::wstring nodeName = L"");
