...
<<<<<<< 2df7295c4921404e7f153b85ee3fdfc4297a1559
...
=======
        ...
        m_leftMinusRight->AssignDifferenceOf(InputRef(0).ValueFor(fr).ElementMultiplyWith(labeled), InputRef(1).ValueFor(fr).ElementMultiplyWith(labeled));
        
>>>>>>> one -> slipped while merging
