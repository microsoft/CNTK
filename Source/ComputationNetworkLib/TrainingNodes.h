...
public:
    ...
    {
        Base::RequestMatricesBeforeForwardProp(matrixPool);
        TypedRequestMatrixFromPool<StatType>(m_savedMean, matrixPool);
        TypedRequestMatrixFromPool<StatType>(m_savedInvStdDev, matrixPool);
    }
    ...
    void RequestMatricesBeforeBackprop(MatrixPool& matrixPool) override
    {
        ...
        TypedRequestMatrixFromPool<StatType>(m_dScale, matrixPool);
        TypedRequestMatrixFromPool<StatType>(m_dBias, matrixPool);
    }

    void ReleaseMatricesAfterBackprop(MatrixPool& matrixPool) override
    {
        Base::ReleaseMatricesAfterBackprop(matrixPool);
        TypedReleaseMatrixToPool<StatType>(m_savedMean, matrixPool);
        TypedReleaseMatrixToPool<StatType>(m_savedInvStdDev, matrixPool);
        ReleaseMatrixToPool(m_dDataDummy, matrixPool);
        TypedReleaseMatrixToPool<StatType>(m_dScale, matrixPool);
        TypedReleaseMatrixToPool<StatType>(m_dBias, matrixPool);
    }
