...
static shared_ptr<ComputationNode<ElemType>> CreateStandardNode(const std::wstring& nodeType, _Types&&... _Args)
{
	...
	else if (nodeType == OperationNameOf(NCECriterionNode))						return New<NCECriterionNode<ElemType>>(forward<_Types>(_Args)...);
	...
	else if (nodeType == OperationNameOf(SampledTimesNode))                     return New<SampledTimesNode<ElemType>>(forward<_Types>(_Args)...);
...
template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::NCECriterion(const ComputationNodePtr label, const ComputationNodePtr prediction, const std::wstring nodeName)
{
	return net.AddNodeToNetAndAttachInputs(New<NCECriterionNode<ElemType>>(net.GetDeviceId(), nodeName), { label, prediction });
}
...
template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::SampledTimes(const ComputationNodePtr a, const ComputationNodePtr b, const ComputationNodePtr c, size_t outputRank, const std::wstring nodeName)
{
	return net.AddNodeToNetAndAttachInputs(New<SampledTimesNode<ElemType>>(net.GetDeviceId(), nodeName, outputRank), { a, b, c });
}
