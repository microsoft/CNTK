...
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::RNNT(const ComputationNodePtr graph, const ComputationNodePtr uttinfo, const ComputationNodePtr mergedinput,
                                                                                const ComputationNodePtr W, const ComputationNodePtr b, const ComputationNodePtr phoneBoundary, int blankTokenId, int delayConstraint, const std::wstring nodeName)
{
    return net.AddNodeToNetAndAttachInputs(New<RNNTNode<ElemType>>(net.GetDeviceId(), nodeName, blankTokenId, delayConstraint), {graph, uttinfo, mergedinput, W, b, phoneBoundary});
}
