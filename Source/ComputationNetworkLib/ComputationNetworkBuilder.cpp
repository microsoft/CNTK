...
static shared_ptr<ComputationNode<ElemType>> CreateStandardNode(const std::wstring& nodeType, _Types&&... _Args)
{
    ...
    else if (nodeType == OperationNameOf(PawnNode))                             return New<PawnNode<ElemType>>(forward<_Types>(_Args)...);
...
template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::IRMetric(const ComputationNodePtr label, const ComputationNodePtr prediction, const ComputationNodePtr pairindex, const std::wstring nodeName)
{
	return net.AddNodeToNetAndAttachInputs(New<IRMetricNode<ElemType>>(net.GetDeviceId(), nodeName), { label, prediction, pairindex });
}

template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::IRMetricEval(const ComputationNodePtr label, const ComputationNodePtr prediction, const ComputationNodePtr pairindex, const std::wstring nodeName)
{
    return net.AddNodeToNetAndAttachInputs(New<IRMetricEvalNode<ElemType>>(net.GetDeviceId(), nodeName), { label, prediction, pairindex });
}
...
template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::SparseElementTimes(const ComputationNodePtr a, const ComputationNodePtr b, const std::wstring nodeName)
{
    return net.AddNodeToNetAndAttachInputs(New<SparseElementTimesNode<ElemType>>(net.GetDeviceId(), nodeName), { a, b });
}
...
template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::Dropout(const ComputationNodePtr a, const ComputationNodePtr b, const std::wstring nodeName)
{
    return net.AddNodeToNetAndAttachInputs(New<DropoutNode<ElemType>>(net.GetDeviceId(), nodeName), { a, b });
}

template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::Pawn(const ComputationNodePtr a, const std::wstring nodeName)
{
    return net.AddNodeToNetAndAttachInputs(New<PawnNode<ElemType>>(net.GetDeviceId(), nodeName), { a });
}

template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::Pawn(const ComputationNodePtr a, const ComputationNodePtr b, const std::wstring nodeName)
{
    return net.AddNodeToNetAndAttachInputs(New<PawnNode<ElemType>>(net.GetDeviceId(), nodeName), { a, b });
}
