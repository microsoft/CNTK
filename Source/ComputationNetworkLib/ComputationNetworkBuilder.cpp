...
static shared_ptr<ComputationNode<ElemType>> CreateStandardNode(const std::wstring& nodeType, _Types&&... _Args)
{
    ...
    else if (nodeType == OperationNameOf(TimeReductionNode))                    return New<TimeReductionNode<ElemType>>(forward<_Types>(_Args)...);
    ...
    else if (nodeType == OperationNameOf(RNNTNode))                             return New<RNNTNode<ElemType>>(forward<_Types>(_Args)...);
...
template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::RNNT(const ComputationNodePtr graph, const ComputationNodePtr uttinfo, const ComputationNodePtr mergedinput,
                                                                                const ComputationNodePtr W, const ComputationNodePtr b, const ComputationNodePtr phoneBoundary, int blankTokenId, 
    ElemType earlyP, ElemType lateP, int delayConstraint, const std::wstring nodeName)
{
    return net.AddNodeToNetAndAttachInputs(New<RNNTNode<ElemType>>(net.GetDeviceId(), nodeName, blankTokenId, earlyP, lateP, delayConstraint), {graph, uttinfo, mergedinput, W, b, phoneBoundary});
}
...
template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::PlusBroadcast(const ComputationNodePtr encoder, const ComputationNodePtr prediction, const ComputationNodePtr uttinfo, const size_t combineMode , const std::wstring nodeName)
{
...
template <class ElemType>
shared_ptr<ComputationNode<ElemType>> ComputationNetworkBuilder<ElemType>::TimeReduction(const ComputationNodePtr in, const ComputationNodePtr uttinfo, const size_t deductionFactor, const std::wstring nodeName)
{    
    return net.AddNodeToNetAndAttachInputs(New<TimeReductionNode<ElemType>>(net.GetDeviceId(), nodeName, deductionFactor), {in, uttinfo});
}
