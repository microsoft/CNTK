...
public:
	...
	static void StochasticBinaryForward(const Matrix<ElemType>& a, Matrix<ElemType>& b);
	static void StochasticBinaryBackward(const Matrix<ElemType>& a, const Matrix<ElemType>& output, const Matrix<ElemType>& outgrad, Matrix<ElemType>& ingrad, const bool neuronST, const bool RFAdjusted, const bool passThrough, const float annealRate);
