...
public:
    ...
    void RNNForward(const Matrix<ElemType>& inputX, const TensorShape shapeX, const Matrix<ElemType>& paramW, const TensorShape shapeY, const size_t numRows, const size_t numHidden, Matrix<ElemType>& reserve, Matrix<ElemType>& workspace);
    void RNNBackwardData(const Matrix<ElemType>& outputDY, const TensorShape shapeY, const Matrix<ElemType>& paramW, Matrix<ElemType>& outputDX, const TensorShape shapeDX, Matrix<ElemType>& reserve, Matrix<ElemType>& workspace);
    void RNNBackwardWeights(const Matrix<ElemType>& inputX, const TensorShape shapeX, const Matrix<ElemType>& outputY, const TensorShape shapeY, Matrix<ElemType>& dw, Matrix<ElemType>& reserve, Matrix<ElemType>& workspace);
