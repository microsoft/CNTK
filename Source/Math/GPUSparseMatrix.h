...
public:
    ...
    static void AddSparseColumnIndex(GPUSparseMatrix<ElemType>& a, const GPUSparseMatrix<ElemType>& b);
    static void AddSparseColumnIndex(GPUSparseMatrix<ElemType>& a, const GPUMatrix<ElemType>& b);
    static void AssignSparseCopyOf(GPUSparseMatrix<ElemType>& a, const GPUSparseMatrix<ElemType>& b, size_t* NzOffset, const size_t RowOffset);
    static void AssignSparseCopyOf(GPUSparseMatrix<ElemType>& a, const GPUMatrix<ElemType>& b, size_t* NzOffset, const size_t RowOffset);
