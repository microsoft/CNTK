...
#if 0   // sanity check for tracking down a bug
...
void GPUSparseMatrix<ElemType>::GatherBatch(size_t numInputs, const std::function<const GPUSparseMatrix<ElemType>&(size_t)>& inputs)
{
    ...
    for (size_t i = 0; i < numInputs; i++)
    {
        ...
        nz += inputCols; // note: this makes a huge difference
        numCols += inputCols;
    }
...
template GPUSparseMatrix<int>::GPUSparseMatrix(GPUSparseMatrix<int> const&);
template GPUSparseMatrix<int>::~GPUSparseMatrix();
template void GPUSparseMatrix<int>::SetValue(CPUSparseMatrix<int> const&);
template void GPUSparseMatrix<int>::SetValue(GPUSparseMatrix<int> const&);
template void GPUSparseMatrix<int>::SetValue(GPUMatrix<int> const&);
template void GPUSparseMatrix<int>::CopyToDenseMatrix(GPUMatrix<int>&) const;
template void GPUSparseMatrix<int>::CopyToCPUSparseMatrix(CPUSparseMatrix<int>&) const;
template void GPUSparseMatrix<int>::AssignColumnSliceToDense(GPUMatrix<int>&, size_t, size_t) const;
