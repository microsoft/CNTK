...
public:
    ...
    std::shared_ptr<MKLDNNStream> current_stream()
    {
...
public:
    ...
    void reset(mkldnn::primitive* pprimitive)
    {
        this->aprimitive.reset(pprimitive);
    }
