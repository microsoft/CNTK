...
namespace msra { namespace strfun { // TODO: rename this
...
#pragma warning(pop)
    ...
    static inline int toint(const wchar_t * s)      { return _wtoi(s); }
    static inline int toint(const char * s)         { return atoi(s); }
