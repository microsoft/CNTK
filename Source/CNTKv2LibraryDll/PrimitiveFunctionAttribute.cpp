...
namespace CNTK
{
    ...
    /*static*/ const std::wstring PrimitiveFunctionAttribute::AttributeMarginInnerProductOutputDimension = L"marginInnerProductOutputDimension";
    /*static*/ const std::wstring PrimitiveFunctionAttribute::AttributeMarginInnerProductBase = L"marginInnerProductOutputBase";
    /*static*/ const std::wstring PrimitiveFunctionAttribute::AttributeMarginInnerProductGamma = L"marginInnerProductOutputGamma";
    /*static*/ const std::wstring PrimitiveFunctionAttribute::AttributeMarginInnerProductPower = L"marginInnerProductOutputPower";
