...
namespace CNTK
{
    ...
    public:
        ...
        BlockFunction(const std::shared_ptr<CompositeFunction>& composite, const std::vector<std::pair<Variable, Variable>>& operands, bool isBasicBlock, bool determineShapes, const std::wstring& blockName = std::wstring());
