...
namespace CNTK
{
    namespace Internal
    {
        ...
        void SaveAsLegacyModel(const FunctionPtr& rootFunction, const std::wstring& modelFile)
        {
            ...
            {
            case DataType::Float:
                computationNetwork = compositeFunction->GetComputationNetwork<float>(device, std::unordered_set<Variable>(), std::unordered_set<Variable>(), std::unordered_set<Variable>(), false);
                break;
            case DataType::Double:
                computationNetwork = compositeFunction->GetComputationNetwork<double>(device, std::unordered_set<Variable>(), std::unordered_set<Variable>(), std::unordered_set<Variable>(), false);
                break;
            default:
