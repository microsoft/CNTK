...
#define DontSeeThroughNoOps // TODO: remove this once backprop works
    ...
    // this gets the non-redirected data fields, which describe v's properties as aninput
...
public:
    ...
    //  - output Variable = f_cuda(input Variables)
    //  - input Variable = f_seeThrough(output Variable)
    ...
    //    output Variable = input Variable -> m_redirect -> m_function -> m_outputs[0]
