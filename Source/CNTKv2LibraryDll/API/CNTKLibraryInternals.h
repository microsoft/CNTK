...
namespace CNTK
{
    ...
    namespace Internal
    {
        ...
        CNTK_API FunctionPtr Gemm(const Variable& operandA, const Variable& operandB, const Variable& operandC, float alpha, float beta, bool transA, bool transB, const std::wstring& name = L"");
