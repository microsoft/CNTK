...
namespace CNTK
{
    ...
    public:
        ...
        CNTK_API static const std::wstring AttributeMarginInnerProductOutputDimension;
        CNTK_API static const std::wstring AttributeMarginInnerProductBase;
        CNTK_API static const std::wstring AttributeMarginInnerProductGamma;
        CNTK_API static const std::wstring AttributeMarginInnerProductPower;
        CNTK_API static const std::wstring AttributeMarginInnerProductLambdaMin;
        CNTK_API static const std::wstring AttributeMarginInnerProductMarginCoefficient;
        CNTK_API static const std::wstring AttributeFeatureNormalizeNormalizeType;
        CNTK_API static const std::wstring AttributeAdditiveFullConnectionOutputDimension;
        CNTK_API static const std::wstring AttributeAdditiveFullConnectionWeightNormalize;
        CNTK_API static const std::wstring AttributeAdditiveFullConnectionBias;
        CNTK_API static const std::wstring AttributeAdditiveFullConnectionAnnealBias;
        CNTK_API static const std::wstring AttributeAdditiveFullConnectionBiasBase;
        CNTK_API static const std::wstring AttributeAdditiveFullConnectionBiasGamma;
        ...
        CNTK_API static const std::wstring AttributeCenterLossNormalize;
        CNTK_API static const std::wstring AttributeGlobalConcatBlockIndex;
        CNTK_API static const std::wstring AttributeGlobalConcatGrowthRate;
        CNTK_API static const std::wstring AttributeGlobalConcatSegmentIndex;
