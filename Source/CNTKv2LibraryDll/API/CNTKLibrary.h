...
namespace CNTK
{
    ...
    static std::atomic<bool> s_isIntializedDefaultPastValueInitialState = ATOMIC_VAR_INIT(false);
    ...
    static std::atomic<bool> s_isIntializedDefaultFutureValueInitialState = ATOMIC_VAR_INIT(false);
