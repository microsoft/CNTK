...
namespace CNTK
{
    ...
    ///
    /// Create an instance of the CNTK built-in elementwise acosh operation with the specified input operand.
    ///
    CNTK_API FunctionPtr Acosh(const Variable& operand, const std::wstring& name = L"");
