...
namespace CNTK
{
    ...
    ///
    CNTK_API FunctionPtr UniformRandom(const Variable& operand, double low = 0.0, double high = 1.0, unsigned long seed = SentinelValueForAutoSelectRandomSeed, const std::wstring& name = L"");
    ...
    ///
    CNTK_API FunctionPtr NormalRandom(const Variable& operand, double mean = 0.0, double scale = 1.0, unsigned long seed = SentinelValueForAutoSelectRandomSeed, const std::wstring& name = L"");
    ...
    ///
    CNTK_API FunctionPtr GumbelRandom(const Variable& operand, double loc = 0.0, double scale = 1.0, unsigned long seed = SentinelValueForAutoSelectRandomSeed, const std::wstring& name = L"");
    ...
    ///
    CNTK_API FunctionPtr BernoulliRandom(const Variable& operand, double mean = 0.5, unsigned long seed = SentinelValueForAutoSelectRandomSeed, const std::wstring& name = L"");
