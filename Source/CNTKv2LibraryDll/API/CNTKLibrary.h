...
namespace CNTK
{
    ...
    ///
    /// Create an instance of the CNTK built-in elementwise swish operation with the specified input operand.
    ///
    CNTK_API FunctionPtr Swish(const Variable& operand, const std::wstring& name = L"");
