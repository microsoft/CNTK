...
#pragma weak NBC_Ineighbor_allgatherv=PNBC_Ineighbor_allgatherv
#define NBC_Ineighbor_allgatherv PNBC_Ineighbor_allgatherv
#endif
int NBC_Ineighbor_allgatherv(void *sbuf, int scount, MPI_Datatype stype,
        void *rbuf, int *rcounts, int *displs, MPI_Datatype rtype, MPI_Comm comm, NBC_Handle* handle) {
...
#pragma weak nbc_ineighbor_allgatherv__ = nbc_ineighbor_allgatherv_f
...
void nbc_ineighbor_allgatherv_f(void *sbuf, int *scount, int *stype, void *rbuf, int *rcounts, int *displs,
        int *rtype, int *fcomm, int *fhandle, int *ierr) 
#else
...
#endif
{
  ...
  /* call NBC function */
  *ierr = NBC_Ineighbor_allgatherv(sbuf, *scount, sdtype, rbuf, rcounts, displs,
           rdtype, comm, handle);
}
#ifdef __cplusplus
}
