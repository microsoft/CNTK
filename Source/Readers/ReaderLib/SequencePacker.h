...
private:
    ...
    void PackSparseSample(char* destination, SequenceDataPtr sequence, size_t sample, size_t elementSize, size_t sampleSize);

    // Packs dense sample into the destination.
    void PackDenseSample(char* destination, SequenceDataPtr sequence, size_t sample, size_t elementSize, size_t sampleSize);
