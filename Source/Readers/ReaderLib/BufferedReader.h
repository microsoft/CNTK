...
{
public:
    BufferedReaderBase(size_t maxSize) :
        m_maxSize(maxSize)
    {
    }

    BufferedReaderBase(size_t maxSize, const char* bufferStart) :
        m_maxSize(maxSize),
        m_buffer(bufferStart, bufferStart + maxSize)
    {
    }
    ...
    virtual void SetFileOffset(const size_t& fileOffset) = 0;
...
class BufferedReader : public BufferedReaderBase
{
public:
    BufferedReader(size_t maxSize, const char * buffer, const size_t& offsetInFile);
