...
Minibatch TextPacker::ReadMinibatch()
{
...
size_t TextPacker::GetSampleSize(StreamDescriptionPtr stream)
{
...
size_t TextPacker::GetMaxSequenceLength(const StreamBatch& batch, size_t streamIndex)
{
    size_t maxLength = 0;
...
MBLayoutPtr TextPacker::PackDenseStream(const StreamBatch& batch, size_t streamIndex)
{
...
MBLayoutPtr TextPacker::PackSparseStream(const StreamBatch& batch, size_t streamIndex)
{
