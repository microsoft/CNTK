    ...
    : m_seed(0), m_provider(provider)
{
    ...
    m_randomizer = std::make_shared<PartialBlockRandomizer>(verbosity, window, bundler, PartialBlockRandomizer::DistributionMode::chunk, true /* useLegacyRandomization */);
