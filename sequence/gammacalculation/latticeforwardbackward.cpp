...
// F. Seide, Nov 2011
//
// $Log: /Speech_To_Speech_Translation/dbn/dbn/latticeforwardbackward.cpp $
// 
// 192   2/19/13 7:27p V-hansu
// 
// 191   1/08/13 7:54p V-hansu
// modify log printing sentence for smbr
// 
// 190   12/25/12 2:08p V-hansu
// remove redundent fprintf in latticeforwardbackward()
// 
// 189   11/23/12 9:43a Fseide
// added some parameter validation to forwardbackward()
// 
// 188   11/23/12 9:26a Fseide
// fixed an unused-argument warning in relation to the previous fix
// 
// 187   11/23/12 8:57a Fseide
// disabled code in forwardbackward() that computes the ground-truth path
// score, as we now deal with this in a different way
// 
// 186   11/05/12 12:22a V-hansu
// undo last checkin :( not got enough time to do so...
// 
// 185   11/02/12 9:56a V-hansu
...
// 
// 184   10/29/12 3:48p V-hansu
// add boostingfactor, not enabled by now.
// 
// 183   10/25/12 7:59p V-hansu
// make codes in PRINT_TIME_MEASUREMENT more neat
// 
// 182   10/22/12 9:53p V-hansu
// add return for mmisignal parallel mode
// 
// 181   10/22/12 9:34p V-hansu
// fix the bug for not PARALLEL_SIL
// 
// 180   10/22/12 5:41p V-hansu
// change the logic of silence alignment part
// 
// 179   10/22/12 2:51p V-hansu
// move PARALLEL_SIL to latticearchive.h and change edgehassil to local
// variable
// 
// 178   10/21/12 7:36p V-hansu
// make cpu_verification work for forwardbackwardalign(), fix the bug
// relating to littlematrixheap
// 
// 177   10/21/12 1:04p V-hansu
// clean up forwardbackwardalign() and phase 0 & 1 in fowardbackward(),
// not tested
// 
// 176   10/19/12 3:24p V-hansu
// forgot to rename in some places
// 
// 175   10/19/12 3:23p V-hansu
// rename dengammas in mmierrorsignal() to errorsignal
// 
// 174   10/19/12 2:42p V-hansu
// new method parallelmmierrorsignal, not finished
// 
// 173   10/19/12 2:32p V-hansu
// modify mmierrorsignal interface again
// 
// 172   10/19/12 2:26p V-hansu
// modify interface of mmisignal to prepare for parallel
// remove some redundent code in mmi dengamma computation
// 
// 171   10/19/12 2:17p V-hansu
// change softalignmode to false to get prepared for mmi
// 
// 170   10/17/12 11:56p V-hansu
// add a comment, initialize logEframecorrecttotal to LOGZERO
// 
// 169   10/17/12 6:07p V-hansu
// rename Eframescorrectdiff to logEframescorrect, rename
// Eframescorrecttotal to logEframescorrecttotal
// 
// 168   10/17/12 3:49p V-hansu
// change eframecorrect from float vector to double vector
// 
// 167   10/13/12 5:01p Fseide
// latticeforwardbackward() now logs lmf, amf, and wp
// 
// 166   10/12/12 1:16a V-hansu
// activate PARALLEL_SIL
// 
// 165   10/09/12 7:43p V-hansu
// add macro CPU_VERIFICATION
// 
// 164   10/08/12 10:56a V-hansu
// deactivate parallel_sil
// 
// 163   10/05/12 5:12p V-hansu
// add cpumode to parallelstate and get cpumode back to work now.
// 
// 162   10/05/12 4:07p V-hansu
// activate parallel silence processing
// 
// 161   10/04/12 9:06p V-hansu
// add copyalignments function to sync back the alignments in cuda mode
// for diagnostic
// 
// 160   10/03/12 6:49p Fseide
// added test code to suppress silence frames
// 
// 159   10/03/12 2:00p Fseide
// new test function sMBRsuppressweirdstuff(), not used
// 
// 158   10/03/12 1:33p Fseide
// bug fix forwardbackwardalign(), no longer skips the last edge if it is
// NOT !NULL;
// added more diagnostics
// 
// 157   10/01/12 4:34p Fseide
// moved dump() into the header so that I can use a lambda for symbol
// lookup
// 
// 156   9/30/12 8:32p Fseide
// htkmlfwordentry moved into htkmlfwordsequence, and renamed to 'word'
// 
// 155   9/30/12 7:06p V-hansu
// prepare for silence processing
// 
// 154   9/30/12 5:26p V-hansu
// add backptr to edgealignments and enable logPergodicskip in lr3transP
// 
// 153   9/30/12 4:35p Fseide
// implemented lattice::dump()
// 
// 152   9/30/12 3:44p Fseide
// bestpathlattice() no longer marked as 'untested' since I just tested
// it, and it seems to work as expected;
// enriched the stats generated by sMBRdiagnostics()
// 
// 151   9/30/12 11:59a Fseide
// sMBRdiagnostics() implemented (but not enabled, we do that only for
// debugging)
// 
// 150   9/30/12 11:27a Fseide
// comments in forwardbackwardlattice(), and renamed returnEframescorrect
// to sMBRmode, which is what it really means
// 
// 149   9/29/12 6:00p V-hansu
// resize Eframescorrectdiff in cpu version of forwardbackwardlattice
// 
// 148   9/29/12 1:20a V-hansu
// add a sil edge counting
// 
// 147   9/28/12 6:09p V-hansu
// (some renames)
// 
// 146   9/28/12 4:36p V-hansu
// change the strategy of silence processing
// 
// 145   9/27/12 11:28p V-hansu
// add sanity check for Eframescorrecttotal
// 
// 144   9/26/12 7:32p V-hansu
// rename sMBRmode to returnEframescorrect, pull sil processing on cpu
// before parallelforwardbackwardalign
// 
// 143   9/26/12 2:29p V-hansu
...
// 
// 142   9/26/12 12:53p Fseide
// errorsignal() renamed to sMBRerrorsignal()
// 
// 141   9/26/12 12:38p Fseide
// trainlayer() now passes a buffer to L.forwardbackward() for
// error-signal computation
// 
// 140   9/25/12 9:37p V-hansu
// change the location of edgeacscores and logpps to make things locally
// 
// 139   9/25/12 1:57p V-hansu
// modify the interface of parallelforwardbackward to get prepared for
// emulation of that
// 
// 138   9/24/12 10:11p V-hansu
// modify the interface for parallelfwbw to prepare for the combined mode.
// turn off parallelforwardbackwardlattice now
// 
// 137   9/24/12 7:12p V-hansu
// finish the combination of latticefwbw and expected frame correct (not
// turned on), modify interface of parallelforwardbackwardlattice to get
// ready for gpu version
// 
// 136   9/24/12 3:28p V-hansu
// ready to combine Eframecorrect and logpps, not get through the
// numerical issue
// 
// 135   9/22/12 10:17p V-hansu
// change the interface of forwardbackwardlattice to get prepared for the
// combination
// 
// 134   9/22/12 9:48p V-hansu
// move the location of forwardbackwardlatticesMBR to prepare for the
// combination.
// 
// 133   9/21/12 10:12p V-hansu
// fix bug relating to cpu verification in forwardbackwardlattice
// 
// 132   9/21/12 10:29a V-hansu
// add cpu verification for parallelforwardbackwardlattice
// 
// 131   9/20/12 1:43p V-hansu
// comment out checklattice() to save time.
// 
// 130   9/19/12 4:15p V-hansu
// comment out the parallel version of forwardbackwardlattice because this
// is not finished yet
// 
// 129   9/19/12 9:33a Fseide
// renamed edgeinfo to edgeinfowithscores, in prep for V2 lattice format
// 
// 128   9/16/12 4:42p V-hansu
// modify the last check-in comment
// 
// 127   9/16/12 4:40p V-hansu
// enable parallel forwardbackward
// 
// 126   9/14/12 1:57p V-hansu
// finish forwardlatticej, change forwardbackwardlattice's lambda into
// normal vector, both not tested
// 
// 125   9/13/12 5:40p V-hansu
// add parallelforwardbackwardlattice, not finished
// 
// 124   9/12/12 2:09p V-hansu
// (fix a condition w.r.t. abcs allocation)
// 
// 123   9/11/12 4:02p V-hansu
// factor out mmierrorsignal
// 
// 122   9/09/12 8:57p V-hansu
// (add some auto_timer)
// 
// 121   9/08/12 7:46p V-hansu
// add #ifdef PRINT_TIME_MEASUREMENT
// 
// 120   9/08/12 6:39p V-hansu
// change the interface of latticeforwardbackward for sMBR, now only use
// signal (numgammas)
// 
// 119   9/07/12 12:36p V-hansu
// replace timers, move all timers to latticefwbw.cpp
// 
// 118   9/07/12 10:26a V-hansu
// remove some useless macro
// 
// 117   9/07/12 9:41a V-hansu
// disable test in edge alignments
// 
// 116   9/07/12 9:33a Fseide
// (fixed signed/unsigned/64-bit warnings for 32-bit build)
// 
// 115   9/07/12 9:24a V-hansu
// format the comments
// 
// 114   9/07/12 8:50a V-hansu
// (add some comments about timing)
// 
// 113   9/07/12 8:45a V-hansu
// add some timer
// 
// 112   9/06/12 8:49p V-hansu
// add return to parallelerrorsignal
// 
// 111   9/06/12 7:44p Fseide
// (cleaned up two log messages)
// 
// 110   9/06/12 7:33p Fseide
// bug fix in scoregroundtruth(): used wrong logLL index
// 
// 109   9/06/12 7:22p Fseide
// bug fix in scoregroundtruth()
// 
// 108   9/06/12 7:08p Fseide
// moved call to scoregroundtruth() earlier, in case it crashes later--for
// debugging
// 
// 107   9/06/12 6:59p V-hansu
// fix test against CPU baseline
// 
// 106   9/06/12 6:58p Fseide
// added a message
// 
// 105   9/06/12 6:56p Fseide
// added state transitions; scoregroundtruth() now complete and ready for
// testing
// 
// 104   9/06/12 6:53p Fseide
// bug fix: thisedgealignments[j] -> thisedgealignmentsj[t];
// scoregroundtruth() nearly finished
// 
// 103   9/06/12 6:23p Fseide
// new method scoregroundtruth() --infrastructure, but not actually
// implemented yet
// 
// 102   9/06/12 6:13p V-hansu
// modify the interface of parallelsMBRerrorsignal
// 
// 101   9/06/12 5:17p V-hansu
// substitute abcs with thisedgealignments in sMBR mode
// 
// 100   9/06/12 3:50p V-hansu
// comment out the comparison code between ground truth and bestpath
// 
// 99    9/06/12 3:43p Fseide
// moved htkmlfwordentry from htkfeatio.h to latticearchive.h, because
// that's the only place that needs it;
// full infrastructure to pass word alignments and LM scores to lattice
// fwbw implemented (but minor bits need filling in, and not tested)
// 
// 98    9/06/12 3:40p V-hansu
// add comparison between bestpath and ground truth
// 
// 97    9/06/12 12:51p V-hansu
// add traceback in forwardbackwardsMBR, not finished yet
// 
// 96    9/06/12 12:43p V-hansu
// fix a bug in bestpathlattice and add backpointers in
// forwardbackwardsMBR
// 
// 95    9/06/12 10:43a Fseide
// now also computes the oracle frame acc, and warns if ground-truth path
// is not in the lattice
// 
// 94    9/06/12 8:10a Fseide
...
// 
// 93    9/05/12 10:54p V-hansu
// 
// 92    9/05/12 7:26p Fseide
// factored sMBR error signal computation to new method sMBRerrorsignal();
// also factored parallelstate up one level
// 
// 91    9/05/12 6:29p Fseide
// new class parallelstate to encapsulate and carry over state from
// parallel lattice processing
// 
// 90    9/05/12 5:30p V-hansu
// fix a bug and undo cputest
// 
// 89    9/05/12 11:26a V-hansu
// disable cpu check
// 
// 88    9/05/12 11:22a V-hansu
// enable linear accumulate in dengammas smbr
// 
// 87    9/05/12 10:59a Fseide
// changed Esignal computation to not use log-add anymore (expensive)
// 
// 86    9/05/12 10:28a Fseide
// minor edits of time measurements
// 
// 85    9/05/12 10:13a V-hansu
// enable cpu checking
// 
// 84    9/05/12 10:07a V-hansu
// add TEST_TIME define
// 
// 83    9/04/12 7:20p V-hansu
// change the testing code
// 
// 82    9/04/12 6:56p V-hansu
// add in non-sil make up code in loop under "we do silence over here"
// 
// 81    9/04/12 6:52p Fseide
// now prints the fw score per frame
// 
// 80    9/04/12 6:49p Fseide
// bug fix in mapping GPU alignments back to abc hack structure
// 
// 79    9/04/12 6:41p Fseide
// another silly bug in test code
// 
// 78    9/04/12 6:40p Fseide
// (minor change--passing 'true' instead of 'returnsenoneids' which
// happens to be true, too)
// 
// 77    9/04/12 6:39p Fseide
// added test code to compare CPU and GPU score and alignment
// 
// 76    9/04/12 6:30p V-hansu
// add some codes to PRINT_ALIGNMENTS
// 
// 75    9/04/12 6:18p Fseide
// fixed silly bug in silence computation (was inside the edge loop...)
// 
// 74    9/04/12 4:04p Fseide
// forwardbackwardalign() in parallel version now does /sil/ in CPU mode
// 
// 73    9/04/12 3:09p V-hansu
// add some printing code and #define PRINT_ALIGNMENTS, off
// 
// 72    9/04/12 11:00a V-hansu
// remove some bug relating to sp through model
// 
// 71    9/01/12 10:18p V-hansu
// add some code in PRINT_EDGE_STATISTICS to print lattice phoneme
// distribution
// 
// 70    9/01/12 7:50p Fseide
// removed unnecessary #include of cuda header
// 
// 69    9/01/12 7:39p Fseide
// removed an unused arg from forwardbackwardalign();
// implemented the back-transplantation of results from
// parallelforwardbackwardalign()
// 
// 68    9/01/12 7:22p Fseide
// completed CUDA wrappers and emulator (but not tested, and inner CUDA
// kernel function still missing)
// 
// 67    9/01/12 5:47p V-hansu
// add some code into PARALLELIZE_FWBW and turn on it for debugging
// 
// 66    9/01/12 3:25p V-hansu
// undef PARALLELIZE_FWBW
// 
// 65    9/01/12 2:46p V-hansu
// add some code to PARALLELIZE_FWBW
// 
// 64    8/31/12 11:23p V-hansu
// add some code to PARALLELIZE_FWBW
// 
// 63    8/31/12 5:15p V-hansu
// add #define PARALLELIZE_FWBW and some parallelization preparation code
// get edgecore into right position
// 
// 62    8/30/12 5:35p V-hansu
// substitute phase 1 in forwardbackward with functions
// forwardbackwardalign (previously not completed)
// 
// 61    8/30/12 3:45p V-hansu
// substitute phase 1 in forwardbackward with functions
// forwardbackwardalign
// 
// 60    8/30/12 3:41p V-hansu
// add another function forwardbackwardalign to get prepared for cuda mode
// 
// 59    8/30/12 2:49p V-hansu
// remove function forwardbackwardedgemodified, alignedgephase1,
// computefinalgammas to make file cleaner
// 
// 58    8/30/12 1:28p V-hansu
// delete some unuseful lines relating to sMBR
// 
// 57    8/28/12 1:55p V-hansu
// add in a printing line
// 
// 56    8/27/12 5:01p V-hansu
// scale done error signal for sMBR by 1/amf
// 
// 55    8/27/12 3:35p V-hansu
// change the copy error relating to expf(numgammas) and swap the
// subtrahend and minuend in computing diff
// 
// 54    8/27/12 8:17 Fseide
// (editorial)
// 
// 53    8/27/12 8:02 Fseide
// added comments
// 
// 52    8/26/12 9:08p V-hansu
// get rid of ratediff in sMBR mode
// 
// 51    8/26/12 8:11p V-hansu
// modify forwardbackwardlattiecsMBR to support pruning
// 
// 50    8/26/12 18:14 Fseide
// changed uids[] to a const_array_ref
// 
// 49    8/26/12 6:03p V-hansu
// finish fwbw for smbr mode, not fully tested
// 
// 48    8/26/12 2:33p V-hansu
// remove a dangerous "break" in fwbw
// 
// 47    8/26/12 2:29p V-hansu
// modify codes in PRINT_STATE_STATISTICS
// 
// 46    8/26/12 14:27 Fseide
// (fixed some comments)
// 
// 45    8/26/12 14:21 Fseide
// (fixed a compiler warning)
// 
// 44    8/26/12 1:38p V-hansu
// modify forwardbackwardlatticesMBR, not tested.
// 
// 43    8/25/12 11:07p V-hansu
// modify forwardbackwardlatticesMBR defination
// 
// 42    8/25/12 10:22p V-hansu
// add another fwbwlattice function for sMBR, not completed yet
// 
// 41    8/25/12 9:37p V-hansu
// add numgamma into fwbw function to get compatible with sMBR
// 
// 40    8/25/12 9:18p V-hansu
// enlarge the matrixheap in fwbw to support frameaccs
// 
// 39    8/25/12 5:04p V-hansu
// (added a comment)
// 
// 38    8/25/12 5:02p V-hansu
// factored out the dup lattice-level forwardback code for phase 0,
// bysharing forwardbackwardlattice();
// added new data structure frameaccs[] in prep for sMBR (not used yet)
// 
// 37    8/25/12 4:38p V-hansu
// forwardbackwardlattice() now takes edgescores[j] as a lambda, so we can
// use it for phase 0 as well
// 
// 36    8/25/12 4:25p V-hansu
// split off the best-path mode from forwardbackwardlattice(), makes it
// simpler (since we will make changes to it)
// 
// 35    8/25/12 4:11p V-hansu
// deleted some checks in lattice fwbw
// 
// 34    8/25/12 4:06p V-hansu
// factored out lattice-level fwbw
// 
// 33    8/24/12 2:13p V-hansu
// added pruning (disabled by default, change minlogpp to enable)
// 
// 32    8/22/12 10:23a V-hansu
// add macro PRINT_STATE_STATISTICS and PRINT_EDGE_STATISTICS to do
// analysis on mmi
// 
// 31    8/17/12 9:42p V-hansu
// modify names of some functions and modify code to get compatible with
// fake edge in lattices.
// 
// 30    5/10/12 2:27p V-hansu
// change latticeforwardbackward into three phases, backed up original
// latticeforwardbackward into latticeforwardbackwardbackup, and
// latticeforwardbackwardedge into latticeforwardbackwardedgebackup.
// 
// 29    3/30/12 16:46 Fseide
// (minor clarification edits to forwardbackwardedge())
// 
// 28    3/30/12 16:21 Fseide
// renamed alphas to logalphas, betas to logbetas, and gammas to loggammas
// for clarity
// 
// 27    3/27/12 11:30 Fseide
// fixed signed/unsigned warnings
// 
// 26    1/12/12 8:35a Fseide
// reenabled softalign
// 
// 25    1/09/12 10:58a Fseide
// implemented Viterbi alignment
// 
// 24    1/08/12 8:03a Fseide
// (added some dumping code)
// 
// 23    1/01/12 3:25p Fseide
// (refined some messages)
// 
// 22    11/21/11 10:25a Fseide
// forwardbackward() now returns the total sum over paths (it really
// should return the precise MMI score, but we don't have the necessary
// information available as of now)
// 
// 21    11/18/11 3:18p Fseide
// (changed a log msg)
// 
// 20    11/18/11 2:08p Fseide
// added statistics for percentage of 0-posteriors
// 
// 19    11/18/11 2:05p Fseide
// now handling 0-probabilities;
// refined accuracy checks
// 
// 18    11/17/11 9:59a Fseide
// added lots of diagnostics to track down the crash
// 
// 17    11/16/11 3:24p Fseide
// (diagnostics msg)
// 
// 16    11/16/11 3:03p Fseide
// (fixed Tabs)
// 
// 15    11/16/11 2:41p Fseide
// (fixed a warning)
// 
// 14    11/16/11 2:34p Fseide
// (logging)
// 
// 13    11/16/11 2:15p Fseide
// (minor change in checks for normalizedness)
// 
// 12    11/16/11 2:10p Fseide
// (enhanced some messages)
// 
// 11    11/16/11 7:41 Fseide
// (added one more check)
// 
// 10    11/16/11 7:34 Fseide
// forwardbackward() completed and tested on one file
// 
// 9     11/16/11 6:45 Fseide
// fixed a compiler warning in x64 builds;
// towards lattice-level forward-backward
// 
// 8     11/15/11 13:40 Fseide
// added lattice-level forward/backward, but still some strange bug
// (posterior > 1)
// 
// 7     11/15/11 10:52 Fseide
// forwardbackward() now takes lmf, wp, and amf
// 
// 6     11/15/11 10:26 Fseide
// sorted out forwardbackwardedge(), seems to be correct now
// 
// 5     11/15/11 9:38 Fseide
// littlematrixheap implemented;
// lots of little changes to forwardbackwardedge(), still one known
// problem (getting there!)
// 
// 4     11/14/11 19:22 Fseide
// added edge-level backward pass, to be tested
// 
// 3     11/14/11 18:39 Fseide
// state-level forward expansion implemented
// 
// 2     11/14/11 11:45 Fseide
// added pieces of code for forward-backward
// 
// 1     11/14/11 9:09 Fseide
// new method lattice::forwardbackward() (empty hull so far)
#if 0
#endif
                                               ...
                                               msra::math::ssematrixbase & loggammas, size_t edgeindex)
{
    ...
    for (size_t k = units.size() -1; k+1 > 0; k--)
    {
        ...
        float exitscore = 1e30; // (something impossible)
