...
def attention_module(context_memory, query_memory, entity_memory, init_status, hidden_dim, init = init_default_or_glorot_uniform):
  ...
  #block_func = ops.as_block(attention, [(c_mem, context_memory.output), (i_status, init_status.output)], 'Attention_module', 'Attention_module')
  #return block_func
  return attention.clone(ops.CloneMethod.share, {c_mem:context_memory, i_status: init_status})
