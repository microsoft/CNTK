...
if(par_dataset_name == "CIFAR10"):
    par_image_height =224# 32*3  # Darknet19 scales input image down over all by a factor of 32.
    par_image_width = 224#32*3   # It needs at least a 3x3 shape for the last conv layer. So 32*3 is required at least.
    par_num_channels = 3  # RGB
    par_input_bias = 114
    par_num_classes = 10
    par_data_path = os.path.join(par_abs_path, "..", "..", "..", "DataSets", "CIFAR-10")
