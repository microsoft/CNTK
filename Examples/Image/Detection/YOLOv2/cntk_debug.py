...
class DebugLayer(UserFunction):
    def __init__(self, arg1, arg2, arg3, name='DebugLayer', debug_name=""):
        ...
        self.call_counter=0
        self.show_every=10*par.par_epoch_size+1
    ...
    def forward(self, arguments, device=None, outputs_to_retain=None):
        ...
        if self.call_counter%self.show_every==0 or self.call_counter==par.par_epoch_size*par.par_max_epochs-1:
            ...
            for i in np.arange(num_images):
                ...
                gt_boxes = gts[i]
                gt_boxes.shape = (par.par_max_gtbs, 5)
    ...
    def _drawText(self, img, pt, text, textWidth=None, color = (255,255,255), colorBackground = None):
