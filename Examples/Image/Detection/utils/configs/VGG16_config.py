...
__C.MODEL.ROI_DIM = 7
## In using Faster R-CNN, try E2E_LR_FACTOR or RPN_LR_FACTOR from 0.1 or smaller.
## They decide learning rate in DNN.
__C.MODEL.E2E_LR_FACTOR = 0.1
__C.MODEL.RPN_LR_FACTOR = 0.1
