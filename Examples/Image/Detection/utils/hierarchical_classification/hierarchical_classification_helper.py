...
class Target_Creator(UserFunction):
    ...
    def infer_outputs(self):
        ...
        #                        self.inputs[0].dtype, self.inputs[0].dynamic_axes, needs_gradient=False, name="hier_label_targets")]
        return [output_variable((FreeDimension, self.hhelper.tree_map.get_nr_of_required_neurons()),
                                self.inputs[0].dtype, self.inputs[0].dynamic_axes, needs_gradient=False, name="hier_label_targets")]
