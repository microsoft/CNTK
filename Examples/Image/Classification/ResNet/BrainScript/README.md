...
The network achieves an error rate of about `8.620%`, which is lower than the number reported in the original paper.
...
The network achieves an error rate of about `6.580%`.
