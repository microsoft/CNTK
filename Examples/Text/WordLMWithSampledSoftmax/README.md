...
Sampled-softmax is a technique to reduce this cost at training time. For details see also the [sampled softmax tutorial](https://github.com/Microsoft/CNTK/blob/release/2.5.1/Tutorials/CNTK_207_Training_with_Sampled_Softmax.ipynb)
