...
int main(int argc, char* argv[])
{
    ...
    const std::string modelFilePath = "../../../../x64/Debug_CpuOnly/z.model"; // "../../../../x64/Debug_CpuOnly/trainer.checkpoint";  //"../../../../x64/Debug_CpuOnly/z.model";  // modelWorkingDirectory + "ATIS.slot.lstm";
