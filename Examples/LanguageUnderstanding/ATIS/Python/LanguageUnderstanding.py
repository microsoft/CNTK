...
if __name__=='__main__':
    ...
    if False:
        def array(vals):
            return np.array(vals, dtype=np.float32) # BUGBUG: Why must the dtype be specified? It is known for each input.
        ...
        #c = Dense(3)
        #c.dump()
        #c = c + 0 # BUGBUG: Without, fails with "ValueError: One of the requested outputs for the Function forward computation is not part of the graph underlying the Function"
        c.dump()
