...
def translator_test_error(z, trainer, input_vocab_dim, label_vocab_dim, debug_output=False):
    ...
    test_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 
       "..",  "SequenceToSequence", "CMUDict", "Data", "cmudict-0.7b.test.ctf")
...
def sequence_to_sequence_translator(debug_output=False, run_test=False):
    ...
    train_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 
                     "..", "SequenceToSequence", "CMUDict", "Data", "cmudict-0.7b.train-dev-20-21.ctf")
    valid_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 
        "..", "SequenceToSequence", "CMUDict", "Data", "tiny.ctf")
    ...
    vocab_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", 
                     "SequenceToSequence", "CMUDict", "Data", "cmudict-0.7b.mapping")
    ...
    logdir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "seq2seq_log")
    train_writer = tf.train.SummaryWriter(logdir=logdir, graph=session.graph, flush_secs=30)
