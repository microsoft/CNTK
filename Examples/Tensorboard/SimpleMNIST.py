...
def simple_mnist(debug_output=False):
    ...
    # Create TF session for tensorboard logging
    session = tf.Session()
    ...
    # Convert CNTK network to TF format and save it as a graph for this TF session
    ...
    # Instantiate a TF summary writer 
