...
// protected:
                         ...
                         std::string prefixMsg)
    {
        ...
        for (;;)
        {
            ...
            bool notAtEndOfEpoch = GetMinibatchIntoNetwork(trainSetDataReader, net, criterionNodes, useDistributedMBReading, useParallelTrain, *inputMatrices, actualMBSize);
            if (!notAtEndOfEpoch)
                break;  // end of epoch
