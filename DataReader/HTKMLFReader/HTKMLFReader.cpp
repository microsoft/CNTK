...
namespace Microsoft { namespace MSR { namespace CNTK {
	...
	{
		throw std::runtime_error("legacyMode no longer supported, InitLegacy has been deprecated\n");
	}
	
	template<class ElemType>
	void HTKMLFReader<ElemType>::InitToTrainOrTest(const ConfigParameters& readerConfig)
	{
		throw std::runtime_error("legacyMode no longer supported, InitToTrainOrTest has been deprecated\n");
	}

	template<class ElemType>
	void HTKMLFReader<ElemType>::InitToWriteOutput(const ConfigParameters& readerConfig)
	{
		throw std::runtime_error("legacyMode no longer supported, InitToWriteOutput has been deprecated\n");
	}
	
	template<class ElemType>
	void HTKMLFReader<ElemType>::InitSingleIO(const ConfigParameters& readerConfig)
	{
		throw std::runtime_error("legacyMode no longer supported, InitSingleIO has been deprecated\n");
	}

	template<class ElemType>
	void HTKMLFReader<ElemType>::InitMultiIO(const ConfigParameters& readerConfig)
	{
		throw std::runtime_error("legacyMode no longer supported, InitMultiIO has been deprecated\n");
	}

	template<class ElemType>
	void HTKMLFReader<ElemType>::InitEvalSingleIO(const ConfigParameters& readerConfig)
	{
		throw std::runtime_error("legacyMode no longer supported, InitEvalSingleIO has been deprecated\n");
	}

	template<class ElemType>
	void HTKMLFReader<ElemType>::InitEvalMultiIO(const ConfigParameters& readerConfig)
	{
		throw std::runtime_error("legacyMode no longer supported, InitEvalMultiIO has been deprecated\n");
	}

	template<class ElemType>
	void HTKMLFReader<ElemType>::InitEvalReader(const ConfigParameters& readerConfig)
	{
		throw std::runtime_error("legacyMode no longer supported, InitEvalReader has been deprecated\n");
	}
	template<class ElemType>
	void HTKMLFReader<ElemType>::StartMinibatchLoopTrain(size_t mbSize, size_t epoch, size_t requestedEpochSamples)
	{
		throw std::runtime_error("legacyMode no longer supported, StartMinibatchLoopTrain has been deprecated\n");
	}

	template<class ElemType>
	void HTKMLFReader<ElemType>::StartMinibatchLoopEval(size_t mbSize, size_t epoch, size_t requestedEpochSamples)
	{
		throw std::runtime_error("legacyMode no longer supported, StartMinibatchLoopEval has been deprecated\n");
	}
		template<class ElemType>
	bool HTKMLFReader<ElemType>::GetMinibatchSingleIO(std::map<std::wstring, Matrix<ElemType>*>& matrices)
	{
		throw std::runtime_error("legacyMode no longer supported, GetMinibatchSingleIO has been deprecated\n");
	}
	
	template<class ElemType>
	bool HTKMLFReader<ElemType>::GetMinibatchMultiIO(std::map<std::wstring, Matrix<ElemType>*>& matrices)
	{
		throw std::runtime_error("legacyMode no longer supported, GetMinibatchMultiIO has been deprecated\n");
	}

	template<class ElemType>
	bool HTKMLFReader<ElemType>:: GetMinibatchEval(std::map<std::wstring, Matrix<ElemType>*>&matrices)
	{
		throw std::runtime_error("legacyMode no longer supported, GetMinibatchEval has been deprecated\n");
	}
	
	template<class ElemType>
	bool HTKMLFReader<ElemType>::GetMinibatchEvalSingleIO(std::map<std::wstring, Matrix<ElemType>*>& matrices)
	{
		throw std::runtime_error("legacyMode no longer supported, GetMinibatchEvalSingleIO has been deprecated\n");
	}

	template<class ElemType>
	bool HTKMLFReader<ElemType>::GetMinibatchEvalMultiIO(std::map<std::wstring, Matrix<ElemType>*>& matrices)
	{
		throw std::runtime_error("legacyMode no longer supported, GetMinibatchEvalMultiIO has been deprecated\n");
	}
	template<class ElemType>
	bool HTKMLFReader<ElemType>::ReNewBuffer(size_t i)
	{
		throw std::runtime_error("legacyMode no longer supported, ReNewBuffer has been deprecated\n");
	}
